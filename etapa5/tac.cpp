...
void tacPrintSingle(TAC *tac)
{
    ...
    auto reverseStr = [](const std::string &s) -> std::string
    {
        std::string r;
...
TAC *generateCode(AST *node)
{
    ...
    {
        // children[0]: tipo, children[1]: tamanho, children[2]: lista de valores
    ...
    case AST_PARAM:
        return tacJoin(tacCreate(TAC_PARAM, node->symbol, 0, 0), children.size() > 1 ? children[1] : nullptr);
